    ...
    <div className="pb-nav animate-fade">
      ...
      <div style={{padding:'16px'}}>
        <div style={{display:'flex', alignItems:'center', gap:'10px', marginBottom:'20px'}}>
          ...
          <h2 style={{fontFamily:'Rajdhani', fontSize:'20px', fontWeight:700}}>Withdraw</h2>
        </div>
        ...
        <div style={{background:'var(--bg-card)', border:'1px solid var(--border)', borderRadius:10, padding:'14px', marginBottom:'16px'}}>
          <div style={{display:'flex', justifyContent:'space-between'}}>
            ...
            <strong style={{color:'var(--accent2)', fontFamily:'Rajdhani', fontSize:'18px'}}>৳{user?.winningBalance || 0}</strong>
          </div>
          <p style={{fontSize:'12px', color:'var(--text-muted)', marginTop:'4px'}}>শুধু Winning Balance থেকে উত্তোলন করা যাবে</p>
        </div>
